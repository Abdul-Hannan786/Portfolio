...
const ProjectsSection = () => {
  return (
    <section className=" overflow-hidden relative py-28  lg:pt-28 ">
      <div className=" mx-auto px-4">

        <h1 className="text-center text-6xl font-obviouslyBold text-[6rem]  dark:text-white text-gray-800 font-bold py-5 uppercase bg-gradient-text bg-clip-text  m-auto">
...
>
  {projects.map((project) => (
    <SwiperSlide key={project.title} className="bg-transparent swiper-slide h-full ">
